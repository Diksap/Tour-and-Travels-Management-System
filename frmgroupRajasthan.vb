...
Public Class frmgroupRajasthan
    ...
    Private Sub btntotal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btntotal.Click
        ...
        If cbtnchild.Checked = True And rbtntrain.Checked = True Then
            tc = (txtnoofchild.Text * 10900) '10000=package amt + 900 = train amt
        End If
        If cbtnadults.Checked = True And rbtntrain.Checked = True Then
            ta = (txtnoofadults.Text * 12200) '10000=package amt + 2200 = train amt
        End If
        If cbtnold.Checked = True And rbtntrain.Checked = True Then
            told = (txtnoofold.Text * 13300) '10000=package amt + 1300 = train amt
        End If

        If cbtnchild.Checked = True And rbtnflight.Checked = True Then
            tc = (txtnoofchild.Text * 12200) '10000=package amt + 2200 = flight amt
        End If
        If cbtnadults.Checked = True And rbtnflight.Checked = True Then
            ta = (txtnoofadults.Text * 14216) '10000=package amt + 4216 = flight amt
        End If
        If cbtnold.Checked = True And rbtnflight.Checked = True Then
            told = (txtnoofold.Text * 13100) '10000=package amt + 3100 = flight amt
        End If
        ...
        cmd = New OleDbCommand("Insert into Temp (B_id,PlaceName,Days,HotelName,HotelType,Food,TravellingMode,FromDate,ToDate,NoofChild,NoofAdult,NoofOld,Total)values('" & lblbookingid.Text & "','" & lblplacename.Text & "','" & lbldays.Text & "','" & lblhotelname.Text & "','" & h & "','" & f & "','" & t & "','" & DateTimePicker1.Value.Date & "','" & DateTimePicker2.Value.Date & "','" & txtnoofchild.Text & "','" & txtnoofadults.Text & "','" & txtnoofold.Text & "','" & txttot.Text & "')", connection)
        cmd.ExecuteNonQuery()

        'show time table information in frmtimetable form
        frmtimetable.Button1.Text = Button1.Text
        frmtimetable.Button2.Text = Button2.Text
        frmtimetable.Button3.Text = Button3.Text
        frmtimetable.Button4.Text = Button4.Text
        frmtimetable.Button5.Text = Button5.Text
        frmtimetable.Button6.Text = Button6.Text
        frmtimetable.Button7.Text = Button7.Text

    End Sub



    Private Sub frmgroupRajasthan_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
