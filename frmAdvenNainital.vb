...
Public Class frmAdvenNainital
    ...
    Private Sub btntotal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btntotal.Click
        ...
        If cbtnchild.Checked = True And rbtnTrain.Checked = True Then
            tc = (txtnoofchild.Text * 13500) '12000=package amt + 1500 = train amt
        End If
        If cbtnadults.Checked = True And rbtnTrain.Checked = True Then
            ta = (txtnoofadults.Text * 15500) '12000=package amt + 3500 = train amt
        End If
        If cbtnold.Checked = True And rbtnTrain.Checked = True Then
            told = (txtnoofold.Text * 14200) '12000=package amt + 2200 = train amt
        End If

        If cbtnchild.Checked = True And rbtnflight.Checked = True Then
            tc = (txtnoofchild.Text * 15500) '12000=package amt + 3500 = flight amt
        End If
        If cbtnadults.Checked = True And rbtnflight.Checked = True Then
            ta = (txtnoofadults.Text * 19000)  '12000=package amt + 7000 = flight amt
        End If
        If cbtnold.Checked = True And rbtnflight.Checked = True Then
            told = (txtnoofold.Text * 17000) '12000=package amt + 5000 = flight amt
        End If
    ...
    Private Sub frmAdvenNainital_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
