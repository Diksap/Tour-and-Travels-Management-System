...
Public Class frmcustomizegoldentraingle
    ...
    Private Sub btntotal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btntotal.Click
        ...
        If cbtnchild.Checked = True And rbtntrain.Checked = True Then
            tc = (txtnoofchild.Text * 11000) '10000=package amt + 1000 = train amt
        End If
        If cbtnadults.Checked = True And rbtntrain.Checked = True Then
            ta = (txtnoofadults.Text * 12500) '10000=package amt + 2500 = train amt
        End If
        If cbtnold.Checked = True And rbtntrain.Checked = True Then
            told = (txtnoofold.Text * 11500)  '10000=package amt + 1500 = train amt
        End If

        If cbtnchild.Checked = True And rbtnflight.Checked = True Then
            tc = (txtnoofchild.Text * 12500) '10000=package amt + 2500 = flight amt
        End If
        If cbtnadults.Checked = True And rbtnflight.Checked = True Then
            ta = (txtnoofadults.Text * 15000) '10000=package amt + 5000 = flight amt
        End If
        If cbtnold.Checked = True And rbtnflight.Checked = True Then
            told = (txtnoofold.Text * 14000) '10000=package amt + 4000 = flight amt
        End If
    ...
    Private Sub frmcustomizegoldentraingle_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
