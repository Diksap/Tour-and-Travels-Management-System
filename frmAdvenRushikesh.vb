...
Public Class frmAdvenRushikesh
    ...
    Private Sub btntotal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btntotal.Click
        ...
        If cbtnchild.Checked = True And rbtntrain.Checked = True Then
            tc = (txtnoofchild.Text * 14350) '13000=package amt + 1350 = train amt
        End If
        If cbtnadults.Checked = True And rbtntrain.Checked = True Then
            ta = (txtnoofadults.Text * 15500) '13000=package amt + 2500 = train amt
        End If
        If cbtnold.Checked = True And rbtntrain.Checked = True Then
            told = (txtnoofold.Text * 14800) '13000=package amt + 1800 = train amt
        End If

        If cbtnchild.Checked = True And rbtnflight.Checked = True Then
            tc = (txtnoofchild.Text * 15500) '13000=package amt + 2500 = flight amt
        End If
        If cbtnadults.Checked = True And rbtnflight.Checked = True Then
            ta = (txtnoofadults.Text * 17900) '13000=package amt + 4900 = flight amt
        End If
        If cbtnold.Checked = True And rbtnflight.Checked = True Then
            told = (txtnoofold.Text * 16700) '13000=package amt + 3700 = flight amt
        End If
    ...
    Private Sub frmAdvenRrushikesh_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
