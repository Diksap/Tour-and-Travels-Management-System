...
Public Class frmcustomizeooty
    ...
    Private Sub btntotal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btntotal.Click
        ...
        If cbtnchild.Checked = True And rbtntrain.Checked = True Then
            tc = (txtnoofchild.Text * 15500) '14000=package amt + 1500 = train amt
        End If
        If cbtnadults.Checked = True And rbtntrain.Checked = True Then
            ta = (txtnoofadults.Text * 17000) '14000=package amt + 3000 = train amt
        End If
        If cbtnold.Checked = True And rbtntrain.Checked = True Then
            told = (txtnoofold.Text * 16500) '14000=package amt + 2500 = train amt
        End If

        If cbtnchild.Checked = True And rbtnflight.Checked = True Then
            tc = (txtnoofchild.Text * 17000) '14000=package amt + 3000 = flight amt
        End If
        If cbtnadults.Checked = True And rbtnflight.Checked = True Then
            ta = (txtnoofadults.Text * 20000) '14000=package amt + 6000 = flight amt
        End If
        If cbtnold.Checked = True And rbtnflight.Checked = True Then
            told = (txtnoofold.Text * 18500) '14000=package amt + 4500 = flight amt
        End If
    ...
    Private Sub frmcustomizeooty_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
