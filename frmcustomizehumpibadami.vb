...
Public Class frmcustomizehumpibadami
    ...
    Private Sub btntotal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btntotal.Click
        ...
        If cbtnchild.Checked = True And rbtntrain.Checked = True Then
            tc = (txtnoofchild.Text * 16700) '15000=package amt + 1700 = train amt
        End If
        If cbtnadults.Checked = True And rbtntrain.Checked = True Then
            ta = (txtnoofadults.Text * 18500) '15000=package amt + 3500 = train amt
        End If
        If cbtnold.Checked = True And rbtntrain.Checked = True Then
            told = (txtnoofold.Text * 17300) '15000=package amt + 2300 = train amt
        End If

        If cbtnchild.Checked = True And rbtnflight.Checked = True Then
            tc = (txtnoofchild.Text * 18500) '15000=package amt + 3500 = flight amt
        End If
        If cbtnadults.Checked = True And rbtnflight.Checked = True Then
            ta = (txtnoofadults.Text * 21720) '15000=package amt + 6720 = flight amt
        End If
        If cbtnold.Checked = True And rbtnflight.Checked = True Then
            told = (txtnoofold.Text * 20000) '15000=package amt + 5000 = flight amt
        End If
    ...
    Private Sub frmcustomizehumpibadami_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
