...
Public Class frmcustomizedarjeeling
    ...
    Private Sub btntotal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btntotal.Click
        ...
        If cbtnchild.Checked = True And rbtntrain.Checked = True Then
            tc = (txtnoofchild.Text * 12000)  '10000=package amt + 2500 = train amt
        End If
        If cbtnadults.Checked = True And rbtntrain.Checked = True Then
            ta = (txtnoofadults.Text * 15000) '10000=package amt + 5000 = train amt
        End If
        If cbtnold.Checked = True And rbtntrain.Checked = True Then
            told = (txtnoofold.Text * 13500) '10000=package amt + 3500 = train amt
        End If

        If cbtnchild.Checked = True And rbtnflight.Checked = True Then
            tc = (txtnoofchild.Text * 15000) '10000=package amt + 5000 = flight amt
        End If
        If cbtnadults.Checked = True And rbtnflight.Checked = True Then
            ta = (txtnoofadults.Text * 20000) '10000=package amt + 10000 = flight amt
        End If
        If cbtnold.Checked = True And rbtnflight.Checked = True Then
            told = (txtnoofold.Text * 17000) '10000=package amt + 7000 = flight amt
        End If
    ...
    Private Sub frmcustomizedarjeeling_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
