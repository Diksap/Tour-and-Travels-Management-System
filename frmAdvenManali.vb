...
Public Class frmAdvenManali
    ...
    Private Sub btntotal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btntotal.Click
        ...
        If cbtnchild.Checked = True And rbtnTrain.Checked = True Then
            tc = (txtnoofchild.Text * 12900) '12000=package amt + 900 = train amt
        End If
        If cbtnadults.Checked = True And rbtnTrain.Checked = True Then
            ta = (txtnoofadults.Text * 14500) '12000=package amt + 2500 = train amt
        End If
        If cbtnold.Checked = True And rbtnTrain.Checked = True Then
            told = (txtnoofold.Text * 13400) '12000=package amt + 1400 = train amt
        End If

        If cbtnchild.Checked = True And rbtnflight.Checked = True Then
            tc = (txtnoofchild.Text * 14500) '12000=package amt + 2500 = flight amt
        End If
        If cbtnadults.Checked = True And rbtnflight.Checked = True Then
            ta = (txtnoofadults.Text * 17000)  '12000=package amt + 5000 = flight amt
        End If
        If cbtnold.Checked = True And rbtnflight.Checked = True Then
            told = (txtnoofold.Text * 15200) '12000=package amt + 3200 = flight amt
        End If
    ...
    Private Sub frmAdvenManali_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnpayment_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnpayment.Click
        ...
        'Add listbox selected name to Selected_volunteer
        Dim q As String
        q = "Insert into Selected_Volunteer(VID,VolunteerName,ContactNo,Address,AdharCardNo)select VID,VolunteerName,ContactNo,Address,AdharCardNo from Volunteer where VolunteerName='" & z & "' "
        cmd = New OleDbCommand(q, connection)
        cmd.ExecuteNonQuery()
        MsgBox("OO")

        'delete listbox selected name to volunteer
        Dim s As String
        s = "Delete from Volunteer where VolunteerName='" & z & "'"
