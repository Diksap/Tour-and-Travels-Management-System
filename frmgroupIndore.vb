...
Public Class frmgroupIndore
    ...
    Private Sub btntotal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btntotal.Click
        ...
        If cbtnadults.Checked = True And rbtntrain.Checked = True Then
            ta = (txtnoofadults.Text * 12100) '10000=package amt + 2100 = train amt
        End If
        If cbtnold.Checked = True And rbtntrain.Checked = True Then
            told = (txtnoofold.Text * 11600) '10000=package amt + 1600 = train amt
        End If

        If cbtnchild.Checked = True And rbtnflight.Checked = True Then
            tc = (txtnoofchild.Text * 12100) '10000=package amt + 2100 = flight amt
        End If
        If cbtnadults.Checked = True And rbtnflight.Checked = True Then
            ta = (txtnoofadults.Text * 14215) '10000=package amt + 4215 = flight amt
        End If
        If cbtnold.Checked = True And rbtnflight.Checked = True Then
            told = (txtnoofold.Text * 12500) '10000=package amt + 2500 = flight amt
        End If
    ...
    Private Sub frmgroupIndore_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
